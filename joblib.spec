...
Source0  : https://files.pythonhosted.org/packages/ef/e9/80bdaef3848e8aa5e518f516bdfb79cc5d81c57ead939c541c20eecd7633/joblib-0.17.0.tar.gz
...
%prep
%setup -q -n joblib-0.17.0
cd %{_builddir}/joblib-0.17.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601999329
...
cp %{_builddir}/joblib-0.17.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/joblib/952b369f76c04f612e5ce4c5ea81eb088b42c2c3
