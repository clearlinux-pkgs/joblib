...
Version  : 1.0.1
Release  : 23
URL      : https://files.pythonhosted.org/packages/6e/1b/b6705e67e288b4f66f99d362ffff0ac93bda3570b0fcb4a5a4e87172108d/joblib-1.0.1.tar.gz
...
%prep
%setup -q -n joblib-1.0.1
cd %{_builddir}/joblib-1.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612904369
...
cp %{_builddir}/joblib-1.0.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/joblib/952b369f76c04f612e5ce4c5ea81eb088b42c2c3
